<%@ Page Language="C#" MasterPageFile="~/MasterPages/Cpanel.Master" AutoEventWireup="true" CodeBehind="TypeLicenceReg.aspx.cs" Inherits="BancoImagens.ControlPanel.TypeLicence.TypeLicenceReg" Title=".:: Fototeca Internacional - Banco de Imagens ::." %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="color: #000000;">
        ...
        <tr>
            ...
            <td style="width: 356px">
                <asp:TextBox ID="txtDescricao" runat="server" MaxLength="80" Width="344px"></asp:TextBox></td>
        </tr>
        <tr>
            <td align="right" style="width: 120px">
                Data de criação:
